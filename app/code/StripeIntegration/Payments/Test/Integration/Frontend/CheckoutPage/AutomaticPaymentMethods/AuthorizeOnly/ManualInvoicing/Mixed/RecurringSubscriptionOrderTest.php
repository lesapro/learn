...
namespace StripeIntegration\Payments\Test\Integration\Frontend\CheckoutPage\AutomaticPaymentMethods\AuthorizeOnly\ManualInvoicing\MixedCart;
...
class RecurringSubscriptionOrderTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testPlaceOrder()
    {
        ...
        $this->tests->event()->trigger("invoice.payment_succeeded", $invoice->id);
