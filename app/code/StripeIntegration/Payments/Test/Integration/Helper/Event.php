...
class Event
{
  ...
  "type": "'.$this->eventType.'"
    ...
    public function triggerSubscriptionEvents($subscription, $test = null)
    {
    ...
    public function triggerEvent($type, $object, $test = null)
    {
        $this->setType($type);
    ...
    public function trigger($type, $object, $test = null)
    {
