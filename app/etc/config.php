...
return [
    'modules' => [
        ...
        'Fovoso_Catalog' => 1,
        'Fovoso_ImportProducts' => 1,
        'RLTSquare_ProductReviewImages' => 1,
        'Fovoso_MegaMenuExtends' => 1,
        'Fovoso_Shipping' => 1,
        'Isobar_OneFieldName' => 1,
        'Klarna_Core' => 1,
        ...
        'Magefan_AutoLanguageSwitcher' => 1,
        'Mageplaza_Core' => 1,
        ...
        'Tuannguyen_ReCaptchaFrontendUi' => 1,
        'Vertex_Tax' => 1,
        'Vertex_AddressValidationApi' => 1,
        'Vertex_RequestLoggingApi' => 1,
        'Vertex_RequestLogging' => 1,
        'Vertex_AddressValidation' => 1,
        'Webkul_GoogleShoppingFeed' => 1,
        'Yotpo_Yotpo' => 1
    ]
];
