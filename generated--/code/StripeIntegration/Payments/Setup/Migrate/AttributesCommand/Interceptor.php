...
class Interceptor extends \StripeIntegration\Payments\Setup\Migrate\AttributesCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addAttributeToAllAttributeSets($attributeCode, $attributeGroupName, $output)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addAttributeToAllAttributeSets', func_get_args(), $pluginInfo) : parent::addAttributeToAllAttributeSets($attributeCode, $attributeGroupName, $output);
    }
