...
class Interceptor extends \StripeIntegration\Payments\Setup\Migrate\SubscriptionPriceCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'initStripeFrom');
        return $pluginInfo ? $this->___callPlugins('initStripeFrom', func_get_args(), $pluginInfo) : parent::initStripeFrom($order);
    }
